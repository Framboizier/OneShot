...
public class LocationsManagerOneShot {
    ...
    private final File file = new File("plugins/OneShot", "locations_oneshot.yml");
    private final FileConfiguration locations = YamlConfiguration.loadConfiguration(this.file);
